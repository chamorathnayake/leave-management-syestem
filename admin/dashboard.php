...
<body>
	<nav class="navbar navbar-toggleable-sm navbar-inverse bg-inverse p-0">
		<div class="container">
			...
			<a href="#" class="navbar-brand mr-3">Online Leave Management System - Admin</a>
	...
	<section id="sections" class="py-4 mb-4 bg-faded">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-2">
					<a href="#" class="btn btn-info btn-block" style="border-radius:0%;" data-toggle="modal" data-target="#addEmpModal"><i class="fa fa-users"></i> Add Employees</a>
				</div>
				<div class="col-md-2">
					<a href="#" class="btn btn-danger btn-block" style="border-radius:0%;" data-toggle="modal" data-target="#viewEmpModal"><i class="fa fa-eye"></i> View Employees</a>
				</div>
				<div class="col-md"></div>
			</div>
		</div>
							 ...
							 <tbody>
							 	...
							 	<tr>
									<td><?php echo $cnt;?></td>
									 ...
									 <td><?php echo $result['leavedateto']; ?></td>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="" method="post">
						<div class="form-group">
							...
							<select name="department" class="form-control">
								...
								<option value="Embrodering">Embrodering</option>
						...
						<div class="form-group">
							...
							<input type="epf" name="epf" class="form-control" />
						</div>
						<div class="form-group">
					...
					<div class="modal-footer">
						<button class="btn btn-dark" style="border-radius:0%;" data-dismiss="modal">Close</button>
						<input type="hidden" name="status" value="0">
						<input type="submit" class="btn btn-info" style="border-radius:0%;" name="adduser"  value="Add">
					</div>
				</form>
			</div>
		</div>
...
<?php 
	if (isset($_POST['adduser'])){
		...
		$sql = "INSERT INTO users(name,department,epf,password)VALUES('$name','$department','$epf','$password')";
